...
<body class="clinic_version">
				...
				<nav class="main-menu">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a class="active" data-scroll href="H_DataPage.jsp">Data
									Show</a></li>
							
							<li><a data-scroll href="H_Add_Patient_infoPage.jsp">Add
									Patient Info</a></li>
					...
					<div class="appointment-form" align="center">
						...
						<div class="form">
							...
							<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<%
									try {
										String hospitalname = (String) session
												.getAttribute("H_Full_Name");
										String hospitalemail = (String) session
												.getAttribute("H_Email_Id");
										int i = 1;
										String query = "select * from sensor_data order by pid asc";
	...
	<div class="copyright-area wow fadeIn"></div>
	<!-- end copyrights -->
