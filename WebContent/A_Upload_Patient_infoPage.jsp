			...
			<div class="container">
				<nav class="main-menu">
					...
					<div id="navbar" class="navbar-collapse collapse">
                        ...
                        <li><a  data-scroll href="A_Upload_Patient_infoPage.jsp">Upload Patient Data</a></li>
							...
							<fieldset>
								...
								<form enctype="multipart/form-data" action="Datasetupload" method="post">
									<table class="form-group">
										<tr>
				<td class="col-md-2">Select a file to upload:</td>
			<td class="col-md-6"> <input type="file" name="file1" id="file1" size="50"/> </td>
				
			</tr>
			<tr>
				<td class="col-md-6" colspan="2" align="center" ><button type="submit">Submit</button> 
				</td>
			</tr>
