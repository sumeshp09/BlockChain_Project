                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                      <li><a  href="HospitalHomePage.jsp">Home</a></li>
                        ...
                        <li><a  data-scroll href=" H_AdmitDataPage.jsp">Admit Data Show</a></li>
                       
                        <li><a data-scroll href="H_AddBedPage.jsp">Add Beds</a></li>
                         <li><a class="active" data-scroll href="H_Add_Patient_infoPage.jsp">Add Patient Info</a></li>
            ...
            <div class="row">
                <div >
                  <div class="appointment-form" align="center">
                     <h3><span>+</span> Patient Status</h3>
                     <div class="form">
                                 ...
                                 <div class="row">
                                    <div class="form-group">
                                       <select class="form-control" name="Beds" id="Beds">
                                          <option selected="selected">Select Info</option>
